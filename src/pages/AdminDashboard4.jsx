            ...
            {selectedCandidate && (
              <div className="mt-8 p-6 bg-white rounded-md shadow-md">
                ...
                <div className="flex items-start">
                  <img
                    src={selectedCandidate.profilePhoto} // Assuming profilePhoto is stored in candidate object
                  ...
                  <div>
                    ...
                    <p className="text-lg"><strong>Subjects:</strong> {selectedCandidate.subjects.join(', ')}</p>
                  </div>
                </div>
              </div>
            )}
