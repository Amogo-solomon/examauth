...
const ExamRegistration = () => {
  ...
  const handleRegister = async (e) => {
    ...
    if (!captureSuccess) {
      alert('Please capture a face image for face recognition.');
      return;
    }
    ...
    const candidateData = {
      ...
      faceDescriptors,
      profileImage, // Save profile image separately
      ...
      <div className="flex flex-col items-center justify-center">
        <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-lg items-center justify-center">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div className="mt-4">
              <label className="block text-gray-700">Upload a profile photo:</label>
              <input
                type="file"
                accept="image/*"
